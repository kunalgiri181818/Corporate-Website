  ...
  class CSF_Setup {
    ...
    public static function add_admin_enqueue_scripts() {
      ...
      // Font awesome 4 and 5 loader
	    $cdn = esc_url('//cdn.'.'jsdelivr.net/');
      if ( apply_filters( 'csf_fa4', false ) ) {
        wp_enqueue_style( 'csf-fa', $cdn.'/npm/font-awesome@4.7.0/css/font-awesome.min.css', array(), '4.7.0', 'all' );
      } else {
        wp_enqueue_style( 'csf-fa5', $cdn.'/npm/@fortawesome/fontawesome-free@5.15.4/css/all.min.css', array(), '5.15.5', 'all' );
        wp_enqueue_style( 'csf-fa5-v4-shims', $cdn.'/npm/@fortawesome/fontawesome-free@5.15.4/css/v4-shims.min.css', array(), '5.15.5', 'all' );
      }
      ...
      wp_localize_script( 'csf', 'csf_vars', array(
        ...
        'i18n'              => array(
          'confirm'         => esc_html__( 'Are you sure?', 'seosight' ),
          'typing_text'     => esc_html__( 'Please enter %s or more characters', 'seosight' ),
          'searching_text'  => esc_html__( 'Searching...', 'seosight' ),
          'no_results_text' => esc_html__( 'No results found.', 'seosight' ),
        ),
      ) );
    ...
    public static function field( $field = array(), $value = '', $unique = '', $where = '', $parent = '' ) {
      ...
      if ( ! empty( $field['_notice'] ) ) {
        ...
        $field            = array();
        $field['content'] = esc_html__( 'Oops! Not allowed.', 'seosight' ) .' <strong>('. $field_type .')</strong>';
        $field['type']    = 'notice';
        $field['style']   = 'danger';
      ...
      if ( ! empty( $field_type ) ) {
        ...
        if ( class_exists( $classname ) ) {
          ...
          echo '<p>'. esc_html__( 'Field not found!', 'seosight' ) .'</p>';
        }
