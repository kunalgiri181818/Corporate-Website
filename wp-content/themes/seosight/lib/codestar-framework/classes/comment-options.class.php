...
if ( ! class_exists( 'CSF_Comment_Metabox' ) ) {
  class CSF_Comment_Metabox extends CSF_Abstract{
    ...
    public function __construct( $key, $params = array() ) {
      ...
      $meta_add = 'add' . '_meta_boxes_comment';
      add_action( $meta_add, array( &$this, 'add_comment_meta_box' ) );
    ...
    public function add_comment_meta_box( $post_type ) {
      $add = 'add' . '_meta_box';
      $add( $this->unique, $this->args['title'], array( &$this, 'add_comment_meta_box_content' ), 'comment', 'normal', $this->args['priority'], $this->args );
    }
