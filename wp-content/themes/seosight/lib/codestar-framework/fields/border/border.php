  ...
  class CSF_Field_border extends CSF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        ...
        'top_placeholder'    => esc_html__( 'top', 'seosight' ),
        'right_placeholder'  => esc_html__( 'right', 'seosight' ),
        'bottom_placeholder' => esc_html__( 'bottom', 'seosight' ),
        'left_placeholder'   => esc_html__( 'left', 'seosight' ),
        'all_placeholder'    => esc_html__( 'all', 'seosight' ),
        'top'                => true,
        'left'               => true,
        'bottom'             => true,
        'right'              => true,
      ...
      $border_props = array(
        'solid'     => esc_html__( 'Solid', 'seosight' ),
        'dashed'    => esc_html__( 'Dashed', 'seosight' ),
        'dotted'    => esc_html__( 'Dotted', 'seosight' ),
        'double'    => esc_html__( 'Double', 'seosight' ),
        'inset'     => esc_html__( 'Inset', 'seosight' ),
        'outset'    => esc_html__( 'Outset', 'seosight' ),
        'groove'    => esc_html__( 'Groove', 'seosight' ),
        'ridge'     => esc_html__( 'ridge', 'seosight' ),
