...
if ( ! class_exists( 'CSF_Field_link_color' ) ) {
  class CSF_Field_link_color extends CSF_Fields {
    ...
    public function render() {
      ...
      $color_props = array(
        'color'    => esc_html__( 'Normal', 'seosight' ),
        'hover'    => esc_html__( 'Hover', 'seosight' ),
        'active'   => esc_html__( 'Active', 'seosight' ),
        'visited'  => esc_html__( 'Visited', 'seosight' ),
        'focus'    => esc_html__( 'Focus', 'seosight' )
      );
